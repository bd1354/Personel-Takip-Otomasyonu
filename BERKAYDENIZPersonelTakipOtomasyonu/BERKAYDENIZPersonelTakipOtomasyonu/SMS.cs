...
namespace BERKAYDENIZPersonelTakipOtomasyonu
{
    internal class SMS
    {
        ...
        public void SmsSender(string TelNo, string SmsText)
        {
            ...
            testXml += "<username>5510658490</username>";// ileti merkezi kullanııc adınız
            testXml += "<password>1g54135g436y</password>";// ileti merkezi kullanıcı şifreniz
            testXml += "</authentication>";
            testXml += "<order>";
            testXml += "<sender>APITEST</sender>";// Size ait olan sms başlığınız
