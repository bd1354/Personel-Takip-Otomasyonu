...
namespace BERKAYDENIZPersonelTakipOtomasyonu
{
    public partial class frmYapilanZamlar : Form
    {
        ...
        private void btnOnay_Click(object sender, EventArgs e)
        {
            ...
            {
                //Radiobutton seçimine göre ya txtYuzde ya da txtFiyat boş kalıyordu bu yüzden buraya alındı
                ...
                if (comboPersoneller.SelectedIndex == 0)
                {
                    ...
                    MessageBox.Show("Tüm personellerin maaşlarına yüzde " + y.Yuzde + " zam yapıldı.","Maaş Zammı",MessageBoxButtons.OK,MessageBoxIcon.Information);
                }
                else
                {
            ...
            if (radioFiyat.Checked)
            {
                ...
                else
                {
                    ...
                    SqlCommand komut = new SqlCommand();
                    Veritabani.ESG(komut, sql);
                    MessageBox.Show(""+comboPersoneller.Text+" personellerin maaşına " + y.Fiyat + " TL zam yapıldı.", "Maaş Zammı", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
